		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<p class="text-center">Silahkan Isi data dibawah untuk mereset passsword</p>
	          ...
	          <div class="w-100 text-center mt-4 text">
	          	<p class="mb-0">Masalah Saat Mengatur Ulang Kata Sandi?</p>
		          <a href="wa.me">Hubungi admin</a>
	          </div>
	        </div>
				</div>
			</div>
